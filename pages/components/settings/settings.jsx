            ...
            <div className="flex w-full h-full">
               ...
               <div className="flex-settings-right flex justify-start pt-16">
                  <div className="px-10 min-w-acc">
                     <span className="text-darkGray-100 font-bold">
                        MY ACCOUNT
                     </span>
                  ...
                  <div className="px-10 pl-0">
                     ...
                     >
                        <span className="rounded-full transform rotate-45 text-darkGray-200 hover:bg-darkGray-650 cursor-pointer border-2 border-darkGray-500 wh-square-md flex">
